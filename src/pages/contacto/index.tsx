...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!navigator.onLine) {
      toast.error(
        'Error: debes tener conexión a internet para poder enviar el formulario.'
      );
      return;
    }
    ...
    try {
      ...
      if (!captchaRef.current.getValue()) {
        toast.error(
          'Error: tienes que realizar la verificación del Recaptcha.'
        );
        return;
      }
      ...
      toast.error('Error: no se pudo enviar el formulario, intente mas tarde.');
    }
              ...
              >
                ...
                {!name.valid && (
                  <span className='input-helper'>
                    El nombre solo puede contener letras y espacios, este campo
                    es obligatorio.
                  </span>
                )}
